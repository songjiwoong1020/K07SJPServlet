...
<body>
	...
	<!-- 페이지 지시어(디렉티브)를 통한 include는 표헌식을 사용 할 수 없다.
	...
	<!-- 
	액션태그의 경우애는 표현식, String 두가지 모두 사용 할 수 있다.
	 -->
	...
	<!-- 
		...
		액션태그
			-jsp소스를 먼저 실행 한 후 실행된 결과를 포함시킨다.
			-따라서 기존페이지에서 선언된 변수는 포함시킨 페이지에서 사용 할 수 없다.
			-다른 페이지를 의미하므로 page영역은 공유되지 않는다.
			-하지만 예외적으로 requset영역은 공유된다.
	 -->
