...
<body>
	...
	<h3>액션태그로 폼값 받기</h3>
	<!-- 
	useBean을 통해 객체생성시 scope속성이 없으면 가장좁은 page영역에 저장된다. default값
	액션태그로 자바빈을 생성 한 후 전송된 폼값을 한번에 설정한다. 폼의 name속성과 1:1로 매칭되는
	DTO의 속성(멤버변수)들이 있기때문에 이와같은 작업이 가능해지게 된다. 이런 형태의 객체를
	"커맨드 객체"라고 한다.
	 -->
