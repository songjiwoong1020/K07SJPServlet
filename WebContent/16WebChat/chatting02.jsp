...
<body>
	<!-- 
	 ...
	 -->
	<input type="text" id="chat_id"	value="<%=session.getId().substring(0, 10)%>"	 
	...
	/*
		웹소켓 연결 후 메세지 전송, 에러발생 등은 모두 이벤트를 통해 함수를 호출한다.
		이때 이벤트 객체가 전달 된다.
	*/
	//연결 되었을때
