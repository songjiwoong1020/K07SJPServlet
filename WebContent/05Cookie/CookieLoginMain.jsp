<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
//request내장객체를 이용하여 쿠키를 읽어온다.
Cookie[] cookies = request.getCookies();
//쿠키에 저장된 아이디를 저장 할 변수 생성
String user = "";
//쿠키가 존재한다면 전체에서 USER_ID라는 쿠미영이 있는지 찾는다.
if(cookies != null){
...
%>
	...
	<!-- 
		input태그의 tabindex속성
		: 포커스 이동을 위해 탭(tab)키를 눌렀을때 포커스가 이동하는
	...
	<table border="1">
		<tr>
			...
			<td>
				...
				<!-- 변수 user에 저장된 값이 있을때 checkbox의 checked속성을 활성화한다. -->
				<input type="checkbox" name="id_save" value="Y" tabindex="3"
					<% if(user.length() != 0){ %> checked="checked" <%} %>/>아이디 저장하기
			</td>
		</tr>
		<tr>
			<td>패스워드</td>
