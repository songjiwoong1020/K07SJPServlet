...
//web.xml에 저장된 context초기화 파라미터를 application객체를 통해 가져옴
...
/*
파라미터를 저장 할 용도로 생성한 Map 컬렉션. 여러개의 파라미터가
있는경우 한꺼번에 저장한 후 DAO로 전달할것임.
*/
Map<String, Object> param = new HashMap<String, Object>();//
//System.out.println("param=" + param);

//폼값을 받아서 파라미터를 저장 할 변수 생성
...
//전체 페이지 수 계산 => 105개 있다 치면 105개 / 10 => 10.5 => ceil(10.5) => 11
int totalPage = (int)Math.ceil((double)totalRecordCount/pageSize);

/*
현재 페이지번호 : 파라미터가 없을때는 무조건 1페이지로 지정하고, 있을때는 해당값을
