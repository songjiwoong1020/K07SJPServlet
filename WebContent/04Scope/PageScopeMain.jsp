...
저장 할 수 있다. Object타입으로 자동 형변환되어 저아되고, 사용시에는
각 객체로 형변환 후 사용하면 된다. 차후 EL(표현언어)을 사용하면 형변환
없이 사용 할 수 있다.
...
<body>
	...
	<%
	/*
	page영역에 저장 될 때 Object타입으로 자동형변환되어 저장되므로
	...
	*/
	...
	<br />
	<%--
		외부파일을 인클루드 하는경우 외부문서는 원본 그대로 현재문서에
		포함 된 후 컴파일 되므로 include 지시어를 사용하는 경우
