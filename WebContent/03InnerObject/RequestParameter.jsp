...
//한글깨짐 방지
	...
	반환하고, 파라미터명이 틀린경우에는 null값을 반환한다.
	*/
	...
	if( !(name==null || name.equals(""))){
		...
		/*
		스크렙트렛 안에서 JS를 선언 할 때는 out.println()을 통해서
		아래와 같이 사용 할 수 있다. 또는 문자열을 연결하여 사용 할 수도 있다.
		*/
		out.println("<script>");
