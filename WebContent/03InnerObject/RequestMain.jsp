...
<body>
	...
	3. <form method="get" 을 사용하는 방법 =>form태그의 디폴트임
	 -->
	<h3>Get방식 전송</h3>
	...
	<form action="RequestParameter.jsp" method="post" name="regFrm" onsubmit="return checkForm(this);">
		...
		자기소개 :
		<br />
		<textarea name="self_intro" cols="30" rows="10">나는 부유한 집안에서 태어나서 대충 싸라씸...</textarea>
		<br />
		<input type="submit" value="POST방식" />
